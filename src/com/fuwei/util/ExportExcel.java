...
public class ExportExcel {
	...
	// 生成报价单excel
	public final static String exportExcel(String fileName,
			List<CompanyPrice> companyPriceList, String imagePath,
			String companyName, String salesName, String time,
		...
		try {
			...
			sheet.addCell(new Label(0, 2, "  №:" + " " + quotationNumber,
					company_wcf_center));
			sheet.mergeCells(0, 3, 6, 3);
			sheet.addCell(new Label(0, 3, "  TO:" + companyName + "   "
					+ salesName, company_wcf_center));

			sheet.mergeCells(0, 4, 6, 4);
			sheet.addCell(new Label(0, 4, "  时间:" + time, company_wcf_center));
			/** ***************以下是EXCEL第4行列标题列********************* */
			...
			for (int i = 0; i < companyPriceList.size(); i++) {
				...
				File pictureFile = new File(imagePath + "ss"
						+ sample.getPicturePath());
				...
				sheet.addCell(new Label(2, 6 + i, companyPriceList.get(i)
						.getProductName(), content_center));
				sheet.addCell(new Label(3, 6 + i, sample.getMaterial(),
						content_center));
				sheet.addCell(new Label(4, 6 + i, sample.getSize(),
						content_center));
				sheet.addCell(new Label(5, 6 + i, sample.getWeight() + " g",
						content_center));
				sheet.addCell(new Label(6, 6 + i, companyPriceList.get(i)
						.getPrice()
						+ "", content_center));
			}
	...
	public final static String exportSampleSignExcel(
			List<UnPricedSample> unpPricedSample, String filePath,
			String fileName) {
	...
	// 生成样品详情
	public final static String exportSampleDetailExcel(Sample sample,CompanyPrice companyPrice,
		...
		try {
			...
			sample_content_center.setBorder(Border.BOTTOM, BorderLineStyle.THIN); // 线条
			...
			sample_content_center.setVerticalAlignment(VerticalAlignment.CENTRE); // 文字垂直对齐
			...
			sample_detail_content_center.setBorder(Border.BOTTOM, BorderLineStyle.THIN); // 线条
			sample_detail_content_center.setBorder(Border.TOP, BorderLineStyle.THIN); // 线条
			sample_detail_content_center.setBorder(Border.LEFT, BorderLineStyle.THIN); // 线条
			sample_detail_content_center.setBorder(Border.RIGHT, BorderLineStyle.THIN); // 线条
			sample_detail_content_center.setVerticalAlignment(VerticalAlignment.CENTRE); // 文字垂直对齐
			...
			sheet.addCell(new Label(0, 2, "款  号", sample_detail_content_center));
			sheet.addCell(new Label(0, 3, "打  样", sample_detail_content_center));
			sheet.addCell(new Label(0, 4, "尺  寸", sample_detail_content_center));
			sheet.addCell(new Label(0, 5, "克  重", sample_detail_content_center));
			sheet.addCell(new Label(0, 6, "材  料", sample_detail_content_center));
			sheet.addCell(new Label(0, 7, "机  织", sample_detail_content_center));
			sheet.addCell(new Label(0, 8, "时  间", sample_detail_content_center));
			sheet.addCell(new Label(0, 9, "价  格", sample_detail_content_center));
			...
			sheet.addCell(new Label(6, 3, "公司款号", sample_detail_content_center));
			sheet.addCell(new Label(6, 4, "业务员", sample_detail_content_center));
			sheet.addCell(new Label(6, 5, "所报价格", sample_detail_content_center));
	...
	public final static String exportProductionNotification(String filePath,
			String fileName,ProductionNotification productionNotification,String picturePath) {
		...
		try {
			...
			sheet.addCell(new Label(1,2,productionNotification.getJiagongdanwei(),content_center3));
			...
			sheet.addCell(new Label(8,2,"№："+productionNotification.getNotificationNumber(),content_center2_1));
			...
			sheet.addCell(new Label(4,5,productionNotification.getProductName(),content_center4));
			
			
			sheet.addCell(new Label(6,5,productionNotification.getExceptProductQuantity()+"",content_center4));
			sheet.addCell(new Label(7,5,productionNotification.getKezhong()+"",content_center4));
			sheet.addCell(new Label(8,5,DateFormateUtil.formateDate(productionNotification.getDeadlineTime()),content_center4));
			sheet.addCell(new Label(9,5,productionNotification.getMachineZhenXing(),content_center4));
			...
			JSONArray  jsonArray=(JSONArray)JSONSerializer.toJSON(productionNotification.getContentJSONString());
			...
			if(jsonArray.size()>-1&&jsonArray.size()<6){
				for (int i = 0; i < jsonArray.size(); i++) {
					sheet.addCell(new Label(0,8+i,jsonArray.getJSONObject(i).getString("sehao"),content_center4));
					sheet.addCell(new Label(1,8+i,jsonArray.getJSONObject(i).getString("sebie"),content_center4));
					sheet.addCell(new Label(3,8+i,jsonArray.getJSONObject(i).getString("size"),content_center4));
					sheet.addCell(new Label(4,8+i,jsonArray.getJSONObject(i).getString("quantity"),content_center4));
					sheet.addCell(new Label(5,8+i,jsonArray.getJSONObject(i).getString("materialName"),content_center4));
					sheet.addCell(new Label(7,8+i,jsonArray.getJSONObject(i).getString("materialQuantity"),content_center4));
					sheet.addCell(new Label(8,8+i,jsonArray.getJSONObject(i).getString("sunhao"),content_center4));
					sheet.addCell(new Label(9,8+i,jsonArray.getJSONObject(i).getString("totalMaterial"),content_center4));
				}
			}
			...
			sheet.addCell(new Label(7,23,"通知时间："+DateFormateUtil.formateDate(productionNotification.getCreatTime()),content_center2));
			...
			if (pictureFile.exists()) {
				WritableImage a = new WritableImage(0, 15, 2, 6,
						pictureFile);
				sheet.addImage(a);
			} else {
