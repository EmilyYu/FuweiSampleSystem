...
public class YaSuoPicture {
	...
	public static void main(String[] arg) {
		...
		System.out.println("输出的图片大小："
				+ mypic.getPicSize("e:\\test\\r1" + ".jpg") / 1024 + "KB");
