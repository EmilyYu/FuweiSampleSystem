				...
				<div class="middle">
					...
					<form method="post" enctype="multipart/form-data" class="form"
						...
						<div class="editor-label">
							...
							<select id="developerId" name="developerId">
								<%
										...
										%>
								<option value="<%=user.getId() %>"><%=user.getChineseName() %></option>
								<%
									}
									else
									{
										List<Developer> developerNameList2 = FuweiSystemData.getDeveloperList();
										for(Developer developer :developerNameList2){
									 	%>
						...
						<div class="editor-label">
							...
							<input type="text" name="material" id="material" class="require" />
						</div>
						<div class="editor-label">
							<label>
								克重:
